...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "urvah", "if we can google anything they why we have to come to class? #ICT", d3);
    private static final Tweet tweet4 = new Tweet(4, "Hassan", "lets party @mahad", d4);
    private static final Tweet tweet5 = new Tweet(5, "faizan", "oo miss hai.", d5);
    private static final Tweet tweet6 = new Tweet(6, "hammad", "GPA la do koi!!", d6);
    ...
    public void testGetMentionedUsers() {
        Set<String> mentionedUser = Extract.getMentionedUsers(Arrays.asList(tweet4));
        
        mentionedUser.contains("mahad");
    }
